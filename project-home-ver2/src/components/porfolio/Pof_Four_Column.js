...
class Pof_Four_Column extends Component {
    render() {
        return (
            <div className="porfoli">
                ...
                <div className="panner">
                        <Panner main="PORTFOLIO" sub="CREATE PORTFOLIO IN FOUR COLUMN" />
                    </div>
                    <div className="container">
                        ...
                        <div className="category pof-four">
                            <div className="row category_list">
                            <div className="col-md-3 filter graphic">
                                <Box_Porfo_V2 img="images/pof1.jpg"/>
                            </div>
                            <div className="col-md-3 filter print">
                                <Box_Porfo_V2  img="images/pof2.jpg"/>
                            </div>
                            <div className="col-md-3 filter webdesign">
...
export default Pof_Four_Column;