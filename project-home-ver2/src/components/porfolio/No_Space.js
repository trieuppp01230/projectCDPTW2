...
class No_Space extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            <div className="no-space">
                ...
                <div className="panner">
                    <Panner main="PORTFOLIO" sub="PORTFOLIO WITHOUT SPACE" />
                </div>
                <div className="container">

                    <div className="nav_menu">
                        <ul className="nav_menu_list clearfix" ref={this.listRef}>
