...
class Pof_Two_Column extends Component {
    render() {
        return (
            <div className="porfoli">
                ...
                <div className="panner">
                        <Panner main="PORTFOLIO" sub="CREATE PORTFOLIO IN TWO COLUMN" />
                    </div>
                    <div className="container">
                        ...
                        <div className="category">
                            ...
                            <div className="col-md-6 filter graphic">
                                <Box_Porfo_V2 img="images/pof1.jpg"/>
                            </div>
                            <div className="col-md-6 filter print">
                                <Box_Porfo_V2  img="images/pof2.jpg"/>
                            </div>
                            <div className="col-md-6 filter webdesign">
