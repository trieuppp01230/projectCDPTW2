...
import './Blog.scss';
class Blog_Three_Column extends Component {
    render() {
        return (
            <div className="grid-column">
                <Menu />
                <div className="panner">
                    <Panner main="BLOG THREE COLUMN" sub="GET MANY MORE FEATURES" />
                </div>
                <div class="container column">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <Classic_Side_Bar img="images/1.jpg" title="PRAESENT MATTIS COMMODO"/>
                        </div>
                    </div>
                </div>
            </div>
...
export default Blog_Three_Column;